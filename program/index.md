...
<table class="table-bordered table-striped table-condensed table-nonfluid">
    ...
    <tr>
        <td>9:00-9:15</td>
        <td>Welcome <a href='http://www.slideshare.net/simondooms/rec-syschallenge2014intro'> (slides) </a> <div align='center'> <img src="../img/presentations/Presentation_Simon.jpg" alt="Presentation Simon"></div> </td>
